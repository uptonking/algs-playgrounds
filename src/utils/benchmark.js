...
//       const suite = this;
//       const result = new suite.constructor(
//         _.assign({}, suite.options, options),
//       );
...
//           } else if (ns.now) {
//             begin = Number(ns.now());
//             while (!(measured = Number(ns.now()) - begin)) {}
//           } else {
...
//       bench.times.timeStamp = Number(_.now());
//       bench.emit(event);
