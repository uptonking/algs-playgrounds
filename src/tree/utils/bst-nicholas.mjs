// https://gist.github.com/subeeshb/dd338088ab04607b18a1
...
BinarySearchTree.prototype = {
  ...
  prettyPrint: function () {
    ...
    const levels = _extractNodes(this._root, 0, []);
    _printNodes(levels);
  },
};
